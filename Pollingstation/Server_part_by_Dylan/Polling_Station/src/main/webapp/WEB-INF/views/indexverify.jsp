    ...
    <div id="main" class="container-narrow">
      <!-- Main hero unit for a primary marketing message or call to action -->
		...
		<div id="main-form-group">
		 <!-- Start voting form -->
		  <form id="main-form" name="myform" action="/receipt/bulletin_board" method="post" class="form-horizontal">
		   <fieldset>
		   <!-- Text input-->
...
<footer>
     <a class="main-button"  href="/login">Coorinator Login?</a>  
</footer>
</div>
      ...
      $(document).ready(function() {
         $("#view-results").click(function(){	 
        	...
        	if($("#sessionID").val() == "" && $("#ballot").val()==""){
        		alert("Please enter Election ID and Ballot ID");
        	}else{
        		if($("#sessionID").val() == ""){
